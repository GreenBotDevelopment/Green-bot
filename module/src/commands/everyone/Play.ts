...
export default class play extends Command {
    ...
    async run({ ctx: a }) {
        ...
        if (!a.me.voiceState.channelID) {
            ...
            if (channel.userLimit == channel.voiceMembers.size) return a.errorMessage("I can't join your channel because the member limit ( Set by a server admin) has been reached! Please increase it or kick someone.")
