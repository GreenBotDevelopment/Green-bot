...
module.exports = {
    ...
    args: true,
    usage: '@user [reason]',
    usages: ["ban @user", "ban @user <reason>"],
    exemple: '@pauldb09 spam',
    cat: 'moderation',
    permissions: ['BAN_MEMBERS'],
    botpermissions: ["BAN_MEMBERS"],
    async execute(message, args, client) {
        let tran = await message.translate("BAN");
        ...
        // Ban the user
        message.guild.members.ban(user, { reason: `${reason} ( ${tran.by} ${message.author.tag})` }).then(async() => {
            ...
            if (logs) {
                if (message.guild.channels.cache.get(logs.channelID)) {
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .addField("<:663041911753277442:830432143800532993> Type", "Ban", true)
