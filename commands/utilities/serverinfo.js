...
<:605031252403290123:830440547717742595> **Emojis**: ${message.guild.emojis.cache.size > 10 ? `${message.guild.emojis.cache.map(x => `${x}`).slice(0,10 )} Et **${message.guild.emojis.cache.size - 10}** autres emojis ` : message.guild.emojis.cache.map(x => `${x}`)}
`)
