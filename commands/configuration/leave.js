...
const prompts = [
    "Bonjour ! commencez par me dire si je doit **activer** ou **désactiver** le système de départ . Répondez par (**enable** ou **disable**) !",
        ...
        m.awaitReactions(filtro, {
            ...
            if (reaccion.emoji.id === "830347712330203146") {
                ...
                if (verify) {
                    ...
                    message.succesMessage(`Votre configuration pour les messages de départ a bien été sauvegardée. `);
                ...
                if (i === 0) {
                    if (content === 'enable') {
                        ...
                        if (verify) {
                            ...
                            return message.succesMessage(`Les messages de départ sont désormais désactivés. `);

                        }
                        return message.succesMessage(`Les messages de départ sont déja désactivés `);
