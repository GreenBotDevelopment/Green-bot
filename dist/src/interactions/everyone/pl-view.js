...
class Queue extends QuickCommand_1.Command {
    ...
    run({ ctx: e }) {
        return __awaiter(this, void 0, void 0, function* () {
            const t = e.args[0].value, n = yield e.client.database.getUser(e.author.id);
            if ("liked-songs" === t) {
                if (!n.songs.length)
                ...
                if (n.songs.length > 6) {
                    ...
                    e.client.collectors.create({
                        ...
                        exec: (a) => __awaiter(this, void 0, void 0, function* () {
                            yield a.defer();
                ...
                if (s.length > 6) {
                    ...
                    e.client.collectors.create({
                        ...
                        exec: (u) => __awaiter(this, void 0, void 0, function* () {
                            yield u.defer();
