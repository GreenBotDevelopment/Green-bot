                    ...
                    embeds: [
                        {
                            ...
                            fields: [
                                { name: "• Now playing", value: `[${e.dispatcher.current ? e.dispatcher.current.info.title.slice(0, 40) : "Nothing Playing"}](https://discord.gg/greenbot) [${e.dispatcher.current ? (0, ExtendedDispatcher_1.humanizeTime)(e.dispatcher.current.info.length) : "00:00"}]` },
                                { name: "• Up next", value: t.map((e, t) => { var _a; return `**${t + 1})** [${(_a = e.info) === null || _a === void 0 ? void 0 : _a.title.slice(0, 40)}](https://discord.gg/greenbot) (Requested by \`${e.info.requester ? e.info.requester.name : "Unknow"}\`)`; }).join("\n") },
