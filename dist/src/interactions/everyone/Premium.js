...
class Premium extends QuickCommand_1.Command {
    ...
    run({ ctx: e }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const r = e.premiumlink("premiumUser") + "userId=" + e.member.id, i = yield fetch(r).catch((t) => e.logger.error(t)), o = yield i.json(), u = e.premiumlink("premiumGuild") + "guildId=" + e.guild.id, a = yield fetch(u).catch((t) => e.logger.error(t)), s = yield a.json();
            ...
            if (t)
                if ("status" === t) {
                    ...
                    if ("activate" === t || "active" === t) {
                        ...
                        yield fetch(t, { method: "post", body: JSON.stringify(r), headers: { "Content-Type": "application/json" } }).catch((t) => e.logger.error(t));
                        const i = e.premiumlink("premiumGuild") + "action=add", u = { guildId: e.guild.id, userId: e.member.id };
                        return (yield fetch(i, { method: "post", body: JSON.stringify(u), headers: { "Content-Type": "application/json" } }).catch((t) => e.logger.error(t)),
