...
class Vibrato extends QuickCommand_1.Command {
    ...
    run({ ctx: e }) {
        return __awaiter(this, void 0, void 0, function* () { return e.dispatcher.player.filters.vibrato ? (e.dispatcher.player.clearFilters(), e.successMessage("⏱ Disabling the `Vibrato` filter to the current song...")) : (e.dispatcher.player.setVibrato({ frequency: 4, depth: .75 }), e.successMessage("⏱ Enabling the `Vibrato` filter to the current song...")); });
    }
}
