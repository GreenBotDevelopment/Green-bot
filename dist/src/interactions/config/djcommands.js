...
class djCommands extends QuickCommand_1.Command {
    get name() {
        return "djcommands";
    }
    get description() {
    ...
    get arguments() {
        return [{ name: "command_name", description: "The command you want to toggle.", required: true, type: 3 }];
    }
    run({ ctx: e }) {
