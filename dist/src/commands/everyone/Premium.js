...
class Premium extends QuickCommand_1.Command {
    ...
    run({ ctx: e }) {
        return __awaiter(this, void 0, void 0, function* () {
            const t = e.args[0];
            if (t) {
                const r = e.premiumlink("premiumUser") + "userId=" + e.member.id, i = yield fetch(r).catch((e) => console.error(e)), o = yield i.json(), s = e.premiumlink("premiumGuild") + "guildId=" + e.guild.id, n = yield fetch(s).catch((e) => console.error(e)), a = yield n.json();
                    ...
                    if ("status" === t) {
                        ...
                        if ("activate" === t || "active" === t) {
                            if (!o)
                                return e.errorMessage("You don't have a premium subscription yet, you need to buy one on the [Patreon page](https://green-bot.app/premium/buy)");
                            if (0 === o.allGuilds)
                                return e.errorMessage("You need to upgrade your subscription to the **Green-bot Premium x1** tier to use this command\n You can upgrade your subscription on the [Patreon page](https://green-bot.app/premium/buy)");
                            if (0 === o.guildsLeft)
                                return e.errorMessage("You have already used all your guilds premium, you need to buy more to use this command.");
                            if (a.guildId)
                            ...
                            yield fetch(t, { method: "post", body: JSON.stringify(r), headers: { "Content-Type": "application/json" } }).catch((e) => console.error(e));
                            const i = e.premiumlink("premiumGuild") + "action=add", s = { guildId: e.guild.id, userId: e.member.id };
                            return (yield fetch(i, { method: "post", body: JSON.stringify(s), headers: { "Content-Type": "application/json" } }).catch((e) => console.error(e)),
                        ...
                        if ("deactivate" === t) {
                            ...
                            if (0 === o.allGuilds)
                                return e.errorMessage("You need to upgrade your subscription to the **Green-bot Premium x1** tier to use this command\n You can upgrade your subscription on the [Patreon page](https://green-bot.app/premium/buy)");
                            if (o.owner !== true) {
                                if (o.allGuilds === o.guildsLeft || !o.premiumGuilds)
                            ...
                            yield fetch(t, { method: "post", body: JSON.stringify(r), headers: { "Content-Type": "application/json" } }).catch((e) => console.error(e));
                            const i = e.premiumlink("premiumGuild") + "action=delete", s = { guildId: e.guild.id };
                            return (yield fetch(i, { method: "post", body: JSON.stringify(s), headers: { "Content-Type": "application/json" } }).catch((e) => console.error(e)),
