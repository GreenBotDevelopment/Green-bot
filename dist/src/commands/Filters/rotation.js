...
class Rotation extends QuickCommand_1.Command {
    ...
    run({ ctx: e }) {
        return __awaiter(this, void 0, void 0, function* () { return e.dispatcher.player.filters.rotation ? (e.dispatcher.player.setRotation(), e.successMessage("⏱ Disabling the `Rotation` filter to the current song...")) : (e.dispatcher.player.setRotation({ rotationHz: 0 }, e.dispatcher.player), e.successMessage("⏱ Enabling the `Rotation` filter to the current song...")); });
    }
}
