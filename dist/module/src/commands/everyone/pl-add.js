...
class Queue extends QuickCommand_1.Command {
    ...
    async run({ ctx: e }) {
        ...
        const r = await user_1.userSchema.findOne({ userID: e.author.id });
        ...
        const o = e.client.shoukaku.getNode(), n = e.args.slice(1).join(" "), u = await e.client.shoukaku.search(o, n, e);
        if (u)
