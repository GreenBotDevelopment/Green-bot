...
class Volume extends QuickCommand_1.Command {
    ...
    get description() { return "Sets the volume of this playback."; }
    get category() { return "Queue Management"; }
    get aliases() { return ["v", "vol", "volume"]; }
    get arguments() { return [{ name: "value", type: 3, description: "The new volume you want me to set to [1-200]" }]; }
