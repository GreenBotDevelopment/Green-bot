...
class Volume extends BaseCommand {get name() { return "jump" }
    ...
    get aliases() { return ["j", "skipto"] }get arguments() { return [{ name: "track", description: "The position of the track you want to jump to", required: !0 }] }
    get playerCheck() { return { voice: !0, dispatcher: !0, channel: !0, vote: !0 } }
    run({ ctx: e }) { let t = e.args[0].replace("#", "") - 1; const r = e.dispatcher.queue[t]; if (!r) return e.errorMessage("There is no track with this number in your queue.");
