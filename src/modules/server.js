                    ...
                    async (e, r) => {
                        ...
                        return (
                            ...
                            s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} just removed ${a.info.title.slice(0, 50)} from the queue using the dashboard`, icon_url: r.avatar } }] }),
                            { done: !0 }
                        );
                    },
                    ...
                    async (e, r) => {
                        ...
                        return t
                            ? (t.lastMessage &&
                              ...
                              s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                  t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just ${t.player.paused ? "paused" : "unpaused"} the current song using the dashboard`, icon_url: r.avatar } }] }),
                              { done: !0 })
                            : void 0;
                    },
                ...
                e.cluster.broadcastEval(
                    async (e, r) => {
                        ...
                        return t
                            ? (t.skip(),
                              s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                  t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just skipped the current song using the dashboard`, icon_url: r.avatar } }] }),
                              { done: !0 })
                            : void 0;
                    },
                    { context: { serv: t, user: a, avatar: u }, cluster: n }
                        ...
                        if (s) {
                            ...
                            if (t) {
                                ...
                                return (
                                    ...
                                    t.skip(),
                                    s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                        t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just played ${e.info.title.slice(0, 30)} using the dashboard`, icon_url: r.avatar } }] }),
                                    { done: !0 }
                                );
                            }
                        }
                    ...
                    async (e, r) => {
                        ...
                        return t
                            ? ((t.queue = t.queue.sort(() => Math.random() - 0.5)),
                              s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                  t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just shuffled the queue using the dashboard`, icon_url: r.avatar } }] }),
                              { done: !0 })
                            : null;
                    },
                    { context: { serv: t, user: a, avatar: u }, cluster: n }
                    ...
                    async (e, r) => {
                        ...
                        return t
                            ? ((t.repeat = "queue" === t.repeat ? "off" : "queue"),
                              s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                  t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just set the repeat mode to ${t.repeat} using the dashboard`, icon_url: r.avatar } }] }),
                              { done: !0 })
                            : null;
                    },
                    { context: { serv: t, user: a, avatar: u }, cluster: n }
                    ...
                    e.cluster.broadcastEval(
                        async (e, r) => {
                            ...
                            return (
                                ...
                                s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                    t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} just played ${a.info.title.slice(0, 40)} using the dashboard`, icon_url: r.avatar } }] }),
                                { done: !0 }
                            );
                        },
                ...
                e.cluster.broadcastEval(
                    async (e, r) => {
                        ...
                        return (
                            ...
                            t.skip(),
                            s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} just jumped to ${a.info.title.slice(0, 150)} using the dashboard`, icon_url: r.avatar } }] }),
                            { done: !0 }
                        );
                    },
                        ...
                        return (
                            ...
                            t
                                ? (t.addTrack(a),
                                  t.playing || t.play(),
                                  s.channels.cache.get(t.player.connection.channelId).members.size > 2 &&
                                      t.metadata.channel.send({ embeds: [{ color: "#3A871F", author: { name: `${r.user} has just added ${a.info.title} from the dashboard`, icon_url: r.avatar } }] }),
                                  { done: !0 })
                                : void 0
                        );
                    },
