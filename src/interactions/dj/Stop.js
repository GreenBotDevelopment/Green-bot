...
class Stop extends BaseCommand {get name() { return "stop" }
    get description() { return "Stops the current playback!" }get aliases() { return ["dc", "destroy", "leave", "disconnect"] }
    get category() { return "Queue Management" }get playerCheck() { return { voice: !0, channel: !0 } }
    run({ ctx: e }) { if (e.dispatcher) e.dispatcher.destroy(!1, !0), e.successMessage("⏹ Successfully stopped the music!");
