...
class GreenBot extends Client {
    constructor(options) {
        ...
        const manager = new GiveawayManagerWithOwnDatabase(this, {  storage: './giveaways.json', updateCountdownEvery: 19e3, default: { botsCanWin: !1, exemptPermissions: [], embedColorEnd: "#ED360E", embedColor: "#3A871F", reaction: "🎁" } });
